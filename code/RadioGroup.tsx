...
export function RadioGroup(props: Partial<Props>) {
    ...
    return (
        <Stack
            ...
            borderRadius={3}
            overflow="hidden"
            border={`1px solid ${valid ? colors.C_Border : colors.S_Warn_500}`}
            // background={colors.C_Border}
        >
            {options.map((option, index) => {
                ...
                return (
                    <RowItem
                        ...
                        validation={() => valid}
                        style={{ borderBottom: `1px solid ${colors.C_Border}` }}
...
addPropertyControls(RadioGroup, {
    ...
    options: {
        ...
        defaultValue: ["Basic", "Perfect", "Ultimate"],
        title: "Options",
    },
    required: {
